...
def topup_commands(base_dir, subject, selected_flow, pa_volume_index, ap_volume_index):
    ...
    acqparam_path = "/your/project/directory/bids/code/preprocessing_dwi/helpers/topup_eddy_extras/acqparams.txt"
    config_path = "/your/project/directory/bids/code/preprocessing_dwi/helpers/topup_eddy_extras/b02b0_ym.cnf"
