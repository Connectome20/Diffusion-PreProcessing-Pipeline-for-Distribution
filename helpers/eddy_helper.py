...
from helpers.create_index_helper import create_index_file
...
def eddy_commands(subject, base_dir, selected_flow):
    ...
    mask_file = f"{base_dir}/{mask_dir_suffix}/brain_mask.nii.gz"
    acqp_file = "/your/project/directory/bids/code/preprocessing_dwi/helpers/topup_eddy_extras/acqparams.txt"
    ...
    topup_file = f"{base_dir}/{topup_dir_suffix}/b0s_topup"
