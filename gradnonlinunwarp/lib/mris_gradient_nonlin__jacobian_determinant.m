...
% $Id: mris_gradient_nonlin__jacobian_determinant.m,v 1.3 2013/07/21 17:16:31 jonp Exp $
%**************************************************************************%
...
%  d3 = d(3);
  ...
  % like interp3, first output argument "X" is HORIZONAL (col direction) and
  % second output argument ("Y") is VERTICAL (row direction).
  ...
  %************************************************************************%
  %%% $Source: /space/repo/1/dev/dev/gradient_nonlin_unwarp/mris_gradient_nonlin__jacobian_determinant.m,v $
  %%% Local Variables:
  %%% mode: Matlab
  %%% fill-column: 76
  %%% comment-column: 0
